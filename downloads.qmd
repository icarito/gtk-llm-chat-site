...
[<i class="bi bi-download"></i>&nbsp; Download .AppImage](https://github.com/icarito/gtk-llm-chat/releases/download/v3.0.0/gtk-llm-chat-x86_64.AppImage){.wai-button .wai-button-primary role="button"}
:::
...
[<i class="bi bi-download"></i>&nbsp; Download .exe](https://github.com/icarito/gtk-llm-chat/releases/download/v3.0.0/gtk-llm-chat-v3.0.0-AMD64.exe){.wai-button .wai-button-primary role="button"}
:::
...
[<i class="bi bi-download"></i>&nbsp; Download .dmg (arm64)](https://github.com/icarito/gtk-llm-chat/releases/download/v3.0.0/gtk-llm-chat-arm64.dmg){.wai-button .wai-button-primary role="button"}
:::
...
[<i class="bi bi-download"></i>&nbsp; Download .dmg (x86_64)](https://github.com/icarito/gtk-llm-chat/releases/download/v3.0.0/gtk-llm-chat-x86_64.dmg){.wai-button .wai-button-primary role="button"}
:::
